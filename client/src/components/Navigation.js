...
<Fragment>
  <ul className="navigation-list">
    ...
    <li className="navigation-item"><Link to={routes.CREATE} className="navigation-link">Create Recipe</Link></li>
  </ul>
  <ul className="navigation-list float-right">
  <li className="navigation-item"><Link to={routes.ACCOUNT} className="navigation-link">My Account</Link></li>
